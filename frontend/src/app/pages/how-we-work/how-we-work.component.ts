...
@Component({
  ...
  <section class="section">
    <div class="container center">
      ...
      <img src="assets/img/how-we-work-lifecycle.png" alt="HDDP full life cycle recruitment process" style="max-width: 560px; width: 100%; margin: 8px auto 36px; border-radius: var(--radius); box-shadow: var(--shadow);">
